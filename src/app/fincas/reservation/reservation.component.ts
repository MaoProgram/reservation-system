...
import { FormularioReservaComponent } from 'src/app/formulario-reserva/formulario-reserva.component';
...
export class ReservationComponent {
  ...
  alquilarFinca(finca: any) {
    const dialogRef = this.dialog.open(FormularioReservaComponent, {
      width: '400px',
      height: '400px',
